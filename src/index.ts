...
export function main() {
    ...
    program
        ...
        .description("generates a Build.json file for (java, javascript, python) to build a Docker")
        .action(() => generateBuildFile())
    
    program 
        .command("gen-db")
        .description("generates database.yml file (mongodb, redis, mysql, postgres)")
        .action(() => generateDB());
